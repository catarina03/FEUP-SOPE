...
//1b)
//Não aparecem erros ?
//Deveriam aparecer erros porque ao não dar lock/unlock, vários processos
//estariam a aceder ao mesmo sítio de memória ao mesmo tempo e isso ia dar porcaria
